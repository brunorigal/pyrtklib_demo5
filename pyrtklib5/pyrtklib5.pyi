...
# ---- vrsgen step-by-step relpos API (relpos_steps.h, HANDMERGE) ----
GIT_SHA: str
class relpos_ctx_t:
    def __init__(self) -> None: ...
    nu: int
    ...
    dt: float
    @property
    def xp(self) -> Arr1Ddouble: ...
    @property
    def Pp(self) -> Arr1Ddouble: ...
    @property
    def xa(self) -> Arr1Ddouble: ...
    @property
    def bias(self) -> Arr1Ddouble: ...
    @property
    def v(self) -> Arr1Ddouble: ...
    @property
    def H(self) -> Arr1Ddouble: ...
    @property
    def R(self) -> Arr1Ddouble: ...
    @property
    def y(self) -> Arr1Ddouble: ...
    @property
    def e(self) -> Arr1Ddouble: ...
    @property
    def azel(self) -> Arr1Ddouble: ...
    @property
    def freq(self) -> Arr1Ddouble: ...
    @property
    def rs(self) -> Arr1Ddouble: ...
    @property
    def dts(self) -> Arr1Ddouble: ...
    @property
    def sat(self) -> Arr1Dint: ...
    @property
    def iu(self) -> Arr1Dint: ...
    @property
    def ir(self) -> Arr1Dint: ...
    @property
    def vflg(self) -> Arr1Dint: ...
def IB_index(sat: int, freq: int, opt: prcopt_t) -> int: ...
def NR_index(opt: prcopt_t) -> int: ...
def rtkpos_pre_relpos(rtk: rtk_t, obs: obsd_t, n: int, nav: nav_t) -> int: ...
def relpos_init(ctx: relpos_ctx_t, rtk: rtk_t, obs: obsd_t, n: int, nav: nav_t) -> int: ...
def relpos_satpos(ctx: relpos_ctx_t, obs: obsd_t) -> int: ...
def relpos_zdres_base(ctx: relpos_ctx_t, obs: obsd_t) -> int: ...
def relpos_selsat(ctx: relpos_ctx_t, obs: obsd_t) -> int: ...
def relpos_udstate(ctx: relpos_ctx_t, obs: obsd_t) -> None: ...
def relpos_float_filter(ctx: relpos_ctx_t, obs: obsd_t) -> int: ...
def relpos_ambiguity_resolution(ctx: relpos_ctx_t, obs: obsd_t) -> int: ...
def relpos_save_solution(ctx: relpos_ctx_t, obs: obsd_t) -> None: ...
def relpos_free(ctx: relpos_ctx_t) -> None: ...
def matrix_diagonal(mat: Arr1Ddouble, n: int): ...
def relpos_extract_sat_data(ctx: relpos_ctx_t, rover_ecef, base_ecef, flags: int = 15) -> dict: ...
def relpos_extract_fixed_amb(ctx: relpos_ctx_t) -> dict: ...
